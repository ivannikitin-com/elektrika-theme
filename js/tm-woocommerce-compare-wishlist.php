...
class TM_WC_Compare_Wishlist {
	...
	*/
	public function register_assets() {
		...
		//wp_register_script( 'tm-woowishlist', tm_wc_compare_wishlist()->plugin_url() . '/assets/js/tm-woowishlist' . $this->suffix . '.js', array( 'jquery' ), 
		wp_register_script( 'tm-woowishlist', tm_wc_compare_wishlist()->plugin_url() . '/assets/js/tm-woowishlist.js', array( 'jquery' ), 
		TM_WC_COMPARE_WISHLIST_VERISON, true );
		...
		wp_localize_script( 'tm-woowishlist', 'tmWoowishlist', array(
			...
			'countFormat' => apply_filters( 'tm_wishlist_count_format', '<span class="wishlist-count">(%count%)</span>' )
		) );
	}
